    ...
    return (
      <div className={s.root}>
        ...
        <div className={s.container}>
          <Navbar fluid className={cx(s.rentAllHeader, 'ListHeader', 'listHeaderAR')} fixedTop={true} expanded={false}>
            <Navbar.Header>
              ...
              <Navbar.Toggle className={cx(s.exitToggle, s.navBarToggle, 'exitToggleRtl')} children={
                <span>
                  <SaveButton
                    step={step}
                    formPage={formPage}
