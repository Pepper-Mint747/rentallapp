...
class PanelWrapper extends Component {
    ...
    render() {
        ...
        const inProgressTitle = <h3 className={s.titleText}><FormattedMessage {...messages.panelHeader1} /></h3>;
        const completedTitle = <h3 className={s.titleText}><FormattedMessage {...messages.panelHeader2} /></h3>;
        let inProgressItems = [];
        let completedItems = [];
