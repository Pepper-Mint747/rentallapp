                ...
                <Row>
                  ...
                  <Col lg={6} md={6} sm={6} xs={12}>
                    <Field
                      ...
                      className={bt.commonControlSelect}
            ...
            !showFilterbuttons && <div className={cx(s.searchResultsCaption, s.filterSection)}>
              <Row>
                <Col xs={12} sm={6} md={6} lg={6} className={s.space2}>
                  <Button className={cx(s.btn, bt.btnPrimaryBorder)} onClick={this.handleFilterClick}>
                    <FormattedMessage {...messages.filter} />
                  </Button>
                </Col>
                <Col xs={12} sm={6} md={6} lg={6} className={cx(s.showSm)}>
                  <Button className={cx(s.btn, bt.btnPrimary)} onClick={showResults}>
                ...
                <Row>
                  <Col lg={7} lgOffset={5} md={8} mdOffset={4}>
                    <Col lg={6} md={6} sm={6} xs={6} className={s.smSpace}>
                      <Button className={cx(s.btn, bt.btnPrimaryBorder, s.fullWidth)} onClick={this.handleFilterClose}>
                        <FormattedMessage {...messages.cancel} />
                      </Button>
                    </Col>
                    <Col lg={6} md={6} sm={6} xs={6}>
                      <Button className={cx(s.btn, bt.btnPrimary, s.fullWidth)} onClick={this.handleFilterSubmit}>
