            ...
            <Col xs={12} smOffset={1} sm={8} mdOffset={1} md={8} lgOffset={1} lg={8}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <FormGroup className={cx(s.formGroup, 'floatLeft')}>
                  <Button className={cx(s.button, bt.btnPrimary, bt.btnLarge)}  onClick={() => nextPage('room')}>
...
export default injectIntl(withStyles(s, bt) (connect(mapState, mapDispatch)(Page1)));
