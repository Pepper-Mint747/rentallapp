                          ...
                          <div className={cx('col-lg-6 col-md-6 col-sm-6 col-xs-12')} key={index}>
                            <div className={s.listPhotoCover}>
                              ...
                              <div className={s.coverPhotoSelection}>
                                ...
                                />
                                <span> <FormattedMessage {...messages.coverLabel} /></span>
                              </div>
                            </div>
                          </div>))
                      }
                  ...
                  <div className={s.nextBackButton}>
                    ...
                    <FormGroup className={s.formGroup}>
                      <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                        ...
                        <Button className={cx(s.button, bt.btnPrimary, bt.btnLarge, s.pullRight, 'floatLeft')} onClick={() => nextPage("description")}>
...
export default injectIntl(withStyles(s, bt)(connect(mapState, mapDispatch)(PhotoCover)))
